...
export type CreateBaseQueryResult<TData = unknown, TError = DefaultError> = Readable<
...
export type CreateInfiniteQueryResult<TData = unknown, TError = DefaultError> = Readable<
	InfiniteQueryObserverResult<TData, TError>
>;

/** Options for createBaseQuery with initialData */
export type DefinedCreateBaseQueryResult<TData = unknown, TError = DefaultError> = Readable<
